...
public class fEmpleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtb_turno = new javax.swing.JTextField();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Empleados"));
        ...
        jtb_turno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtb_turnoActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jtb_turno, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel12)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jtb_ingreso, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtb_turno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel11))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jbot_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbot_guardarActionPerformed
        ...
        if (jtb_edad.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debes ingresar un turno");
            jtb_turno.requestFocus();
            return;
        }
        ...
        dts.setTurno(jtb_turno.getText());
        ...
        if (accion.equals("Guardar")) {
            ...
            if (func.actualizar(dts)) {
                JOptionPane.showMessageDialog(rootPane, "El Empleado fue actualizado satisfactoriamente");
                mostrar("");
                habilitar();
            }
        }
    ...
    private void jtable_empleadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtable_empleadoMouseClicked
        ...
        int fila = jtable_empleado.rowAtPoint(evt.getPoint());

        jtb_id.setText(jtable_empleado.getValueAt(fila, 0).toString());
        jtb_nombre.setText(jtable_empleado.getValueAt(fila, 1).toString());
        jtb_direccion.setText(jtable_empleado.getValueAt(fila, 2).toString());
        jtb_telefono.setText(jtable_empleado.getValueAt(fila, 3).toString());
        jtb_edad.setText(jtable_empleado.getValueAt(fila, 4).toString());
        jtb_turno.setText(jtable_empleado.getValueAt(fila, 5).toString());
        jtb_ingreso.setText(jtable_empleado.getValueAt(fila, 6).toString());
    ...
    private void jtb_turnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtb_turnoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtb_turnoActionPerformed
    ...
    private javax.swing.JTextField jtb_turno;
